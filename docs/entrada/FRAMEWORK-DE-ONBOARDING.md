...
| 6. Aplicações e qualidade | Data Apps, Streamlit/Dune quando aplicável, governança, performance e observabilidade | Protótipo de consumo ou roteiro técnico de solução | 2 vídeos + demo curta |
