...
- Guia único por perfil em `docs/perfis/`; `COMECE-AQUI.md` é apenas roteador.
- Backlog com definição completa por item e âncoras (`#onb-01`, `#cdf-02`, …) em `docs/governanca/04-BACKLOG-DE-ONBOARDING.md`.
- Roteiros de vídeo em `docs/treinamento/Vxx/` com seção **Entrega vinculada** ao backlog.
